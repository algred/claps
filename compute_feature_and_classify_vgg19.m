...
model_path = '/research/action_videos/caffe_v1.0/caffe/models/ucf101_vgg19'
model_def_file = ['caffe/VGG_ILSVRC_19_layers_deploy.prototxt']
model_file = [model_path filesep 'ucf101augVGG19Split' num2str(split) ...
    'cont_iter_20000.caffemodel'];
...
model_def_file = ['caffe/VGG_ILSVRC_19_layers_deploy_L1.prototxt']
